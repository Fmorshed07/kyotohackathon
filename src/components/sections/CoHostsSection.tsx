...
const CoHostsSection = () => {
  const { ref, isVisible } = useScrollReveal<HTMLDivElement>({ threshold: 0.2 });

  return (
    <section className="relative overflow-hidden px-6 py-24" id="cohosts">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <motion.div
          className="absolute left-1/2 top-10 h-56 w-56 -translate-x-1/2 rounded-full bg-primary/10 blur-3xl"
          animate={{ y: [0, 14, 0], opacity: [0.2, 0.35, 0.2] }}
      ...
      <div className="mx-auto max-w-5xl text-center">
        ...
        >
          Creator Labo and TIU Impact Next
        </motion.h2>
